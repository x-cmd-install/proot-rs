...
[![x-cmd/install — proot-rs Code Quality Monitoring Repo Card](https://repo.x-cmd.io/proot-rs.svg?lang=zh)](https://x-cmd.com/install/proot-rs)
...
- **Star**: 160 · **Fork**: 28 · **开放 issue**: 36 · **贡献者**: 6
...
_数据快照: `data/card/260921.yml` · 2026-09-21T05:25:02Z._

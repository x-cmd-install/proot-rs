...
[![x-cmd/install — proot-rs Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/proot-rs.svg?lang=zh)](https://x-cmd.com/install/proot-rs)
...
- **Star**: 161 · **Fork**: 28 · **开放 issue**: 36 · **贡献者**: 6
...
_数据快照: `data/card/260926.yml` · 2026-09-26T05:13:48Z._
